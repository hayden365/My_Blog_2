...
const GoogleLoginButton = () => {
  ...
  return (
    <button
      onClick={() => login()}
      className="flex items-center justify-center gap-1 min-w-[300px] border-black border-1 rounded-sm p-1 cursor-pointer mt-10 shadow-md hover:shadow-lg transition-all duration-300"
    >
