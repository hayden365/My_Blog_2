...
const LoginPage = () => {
  ...
  return (
    <div className="flex flex-col gap-2 mx-auto h-screen mt-20">
      ...
      <span>계속하려면 Google 계정으로 로그인해 주세요.</span>
      <button
        onClick={() => login()}
        className="flex items-center justify-center gap-1 border-black border-1 rounded-sm p-1 cursor-pointer mt-10 shadow-md hover:shadow-lg transition-all duration-300"
      >
